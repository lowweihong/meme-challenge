...
class CustomBLIP(nn.Module):
    def __init__(self,
        ...
        self.blip = BlipForQuestionAnswering.from_pretrained("Salesforce/blip-vqa-capfilt-large")
        ...
        image_map_layers = [nn.Linear(self.blip.vision_model.config.projection_dim, self.map_dim),
    ...
    def forward(self, batch, device):
        ...
        image_embeds = self.blip.vision_model(pixel_values = pixel_values.squeeze(1),
        ...
        text_embeds = self.blip.text_encoder(input_ids = input_ids.squeeze(1), 
                                    attention_mask=attention_mask.squeeze(1), 
